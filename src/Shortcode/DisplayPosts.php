...
class DisplayPosts extends AbstractShortcode
{
     ...
     *
     *     class DisplayPosts extends \Bakeoff\Wordpress\Shortcode\DisplayPosts
     *     {
    ...
    /**
     * See \Bakeoff\Wordpress\Shortcode\AbstractShortcode::render()
     */
