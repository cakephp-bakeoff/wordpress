 ...
 *
 * @package Bakeoff\Wordpress\Controller
 */
class StylesheetsController extends AppController
{
     ...
     *
     * @param $blogSymbol blog symbol, as defined in config/Bakeoff/Wordpress.php
    ...
    public function output($blogSymbol, $key)
    {
        ...
        $blog = new \Bakeoff\Wordpress\Connector($blogSymbol);
