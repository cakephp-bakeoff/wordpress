...
Provide links to the stylesheets you would like to load under `externalCss` in [`config/Bakeoff/Wordpress-dist.php`](blob/master/config/Bakeoff/Wordpress-dist.php).
