...
abstract class Abstract${ALIAS}Table extends \Bakeoff\Wordpress\Model\Table\PluginTable
{
...
abstract class Abstract${ENTITY} extends \Bakeoff\Wordpress\Model\Entity\PluginEntity
{
